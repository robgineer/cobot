...
class CalibrationGUI:
    ...
    def _start_recording(self):
        ...
        self.node.set_new_subscription(topic=config['camera_image_topic'])
    ...
    def _load_parameters(self):
        ...
        try:
            ...
            if filename:
                ...
                messagebox.showinfo("Success", f"Parameters loaded successfully from:\n{filename}")
            else:
    ...
    def spin_once(self, timeout_sec: float = 0.1, period: float = 0.1):
...
class ImageSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            Image,
            'invalid', #'/camera/camera/color/image_raw', #config['camera_image_topic'],
    ...
    def set_new_subscription(self, topic: str):
        """Set a new subscription topic for the image subscriber"""
        ...
        self.get_logger().info(f"Subscribed to new topic: {topic}")
